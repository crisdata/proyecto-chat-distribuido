...
local. No es necesario editar nada para la primera ejecución.
...
Este paso solo es necesario la primera vez. El modelo queda almacenado
en el volumen `proyecto1_ollama_data` y no necesita descargarse de nuevo.
...
Para ver el estado de las colas y conexiones en tiempo real:
